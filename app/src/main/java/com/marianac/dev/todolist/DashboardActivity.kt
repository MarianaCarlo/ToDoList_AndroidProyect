package com.marianac.dev.todolist
...
import com.marianac.dev.todolist.DTO.ToDo
...
class DashboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab_dashboard.setOnClickListener(){
            ...
            val view = layoutInflater.inflate(R.layout.activity_dialog_dashboard, null)
    ...
    class DashboardAdapter(val activity : DashboardActivity,val list: MutableList<ToDo>) : RecyclerView.Adapter<DashboardAdapter.ViewHolder>() {
        ...
        override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder{
            return ViewHolder(LayoutInflater.from(activity).inflate(R.layout.activity_rv_child_dashboard, p0, false))
        }
        ...
        override fun onBindViewHolder(holder: ViewHolder, p1: Int) {
            ...
            holder.todoName.setOnClickListener() {
                ...
                intent.putExtra(INTENT_TODO_NAME, list[p1].id)
